...
/**
 * @program: VerticalSplitTestCase
 * @description:
 * @author: zhuruiqi
 * @create: 2019-02-15 15:22
 **/
public class VerticalSplitTestCase extends AbstractTestCase {
    ...
    @Test
    public void testVerticalSplit() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(fileGroupElementLocater.verticalSplitBtn()));
        webDriver.findElement(fileGroupElementLocater.verticalSplitBtn()).click();
        Thread.sleep(1000);

        Assert.assertTrue(isElementPresent(By.xpath("//div[@class='pane-container column resizable']")));
